...
\pf{
We first consider the case that $F$ is a 1-homogeneous, convex function normalized so that $F(1,\cdots,1)=n$. Homogeneity and convexity implies that $F \geq \tfrac{F(1, \cdots, 1)}{n} H$ and so the chosen normalisation implies,
\begin{equation}
