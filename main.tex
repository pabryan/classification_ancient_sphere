...
\pf{
We first consider the case that $F$ is a 1-homogeneous, convex function normalized so that $F(1,\cdots,1)=n$. The non-collapsing result of \cite[Theorem 1.1]{AndrewsHanLiWei:/2015} states any ancient solution of the flow with a 1-homogeneous convex speed $F$ satisfies
...
Due to the concavity of $F$, we have for any fixed index $i\cn$
