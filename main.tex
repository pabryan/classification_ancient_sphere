...
\begin{thm}
\label{thm:main}
Let \(M_t\) be a smooth, \emph{quasi-ancient}, convex solution of $\dot{x}=-F\nu,$ where $F$ satisfies \cref{F} and such that
...
Convexity and 1-homogeneity implies that $F\geq \tfrac{F(1,\cdots,1)}{n} H;$ see \cite[Lemma~2.2.20]{Gerhardt:/2006}. The chosen normalization then implies,
\begin{equation}
\label{eq:speed_ineq}
...
\end{rem}
\begin{rem}
In view of Lemma \ref{},  any convex ancient solution of \ref{} becomes strictly convex 
\end{rem}
